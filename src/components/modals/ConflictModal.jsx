  ...
  return (
    <Modal isOpen={isOpen} onClose={onDismiss}>
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-xl font-medium text-gray-900 dark:text-gray-100">Sync Conflict</h3>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <button 
          ...
          className="flex-1 px-4 py-2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 font-medium rounded-lg hover:bg-gray-800 dark:hover:bg-white transition-colors flex items-center justify-center gap-2"
        >
